...
INSERT INTO `agendamedica` VALUES ('123123','2017-05-10','7:00-9:30','0101'),('12333','2017-05-02','7:30-9:30','1110'),('2222','2017-05-10','7:00-9:30','0101');
...
INSERT INTO `cama` VALUES ('0330','52','01'),('0331','53','02'),('0332','54','03');
...
INSERT INTO `cita` VALUES ('123123','2017-05-04','7:00-7:00','001','1','2','13','0101'),('12323','2017-05-10','7:00-8:30','001','1','0','13','1110'),('1234','2017-05-04','7:00-7:00','001','1','1','13','0101');
...
INSERT INTO `consultorio` VALUES ('12','ghg','1'),('13','as','1');
...
INSERT INTO `estado_cama` VALUES ('52','disponible'),('53','ocupada'),('54','pendiente por asignar');
...
CREATE TABLE `habitacion` (
  ...
  `cantidad_camas` int(11) DEFAULT NULL COMMENT 'cantidad_camas',
  `id_consultario` varchar(2) NOT NULL COMMENT 'id_consultario',
  `id_cama` varchar(5) NOT NULL COMMENT 'id_cama',
  PRIMARY KEY (`id_habitacion`),
  KEY `id_cama` (`id_cama`),
  KEY `id_consultario` (`id_consultario`),
  CONSTRAINT `habitacion_ibfk_1` FOREIGN KEY (`id_cama`) REFERENCES `cama` (`id_cama`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `habitacion_ibfk_2` FOREIGN KEY (`id_consultario`) REFERENCES `consultorio` (`id_consultorio`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `medico` VALUES ('0101','Juan','Perez','2131321','wqeqwqw12312','cddd@fdfd.com','23123123123123','2017-05-31','1092','2'),('1110','Pedro','Sanchez','312122121121','asdasd','caherer@pepito.com','21323','2017-05-02','1094909434','1');
...
INSERT INTO `paciente` VALUES ('001','JuanR','Sanchez','B los olivos 13 # 12','3889-02-23','312222332',34,'1234','1','1','1'),('123','gh','gh','h','2017-05-04','123',123,'12333','1','1','1'),('12312','sdsad','sdfds','sdfds','2017-05-05','123454354',12312,'10954904905','1','2','1'),('1232','wsadasd','asdasdas','asdasd',NULL,'1321312',1212,'12312312','1','1','1'),('1243','hh','HH','asadas',NULL,'12312',1312,'13123','2','2','1'),('345','fg','fg','fg','2017-05-03','565',5565,'12312','1','1','1'),('8989','GHG','GHGHG','HHGG','2017-05-11','1232',12321,'1001010','1','1','1');
...
-- Dump completed on 2017-05-20 18:41:37
