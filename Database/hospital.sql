...
CREATE TABLE `agendamedica` (
  ...
  `hora_agenda` time DEFAULT NULL COMMENT 'hora_agenda',
...
CREATE TABLE `cita` (
  ...
  CONSTRAINT `cita_ibfk_1` FOREIGN KEY (`id_consultario`) REFERENCES `consultorio` (`id_consultario`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  CONSTRAINT `cita_ibfk_3` FOREIGN KEY (`id_medico`) REFERENCES `medico` (`id_medico`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `consultorio` (
  `id_consultario` varchar(2) NOT NULL COMMENT 'id_consultario',
  `descripcion_consultorio` varchar(2) DEFAULT NULL COMMENT 'descripcion_consultorio',
  `id_estado_consultorio` varchar(2) NOT NULL COMMENT 'id_estado_consultorio',
  PRIMARY KEY (`id_consultario`),
  KEY `id_estado_consultorio` (`id_estado_consultorio`),
  CONSTRAINT `consultorio_ibfk_1` FOREIGN KEY (`id_estado_consultorio`) REFERENCES `estado_consultorio` (`id_estado_consultorio`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `estado_cita` VALUES ('1','activa'),('2','cancelada');
...
CREATE TABLE `estado_consultorio` (
  `id_estado_consultorio` varchar(2) NOT NULL COMMENT 'id_estado_consultorio',
  `descripcion_estado_consultorio` varchar(45) DEFAULT NULL COMMENT 'descripcion_estado_consultorio',
...
INSERT INTO `estado_consultorio` VALUES ('1','Medico general'),('2','Medico especialista');
...
CREATE TABLE `habitacion` (
  ...
  CONSTRAINT `habitacion_ibfk_2` FOREIGN KEY (`id_consultario`) REFERENCES `consultorio` (`id_consultario`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `tipo_cita` VALUES ('12','General'),('13','Especializada');
...
-- Dump completed on 2017-05-03 20:32:42
